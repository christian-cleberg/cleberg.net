...
<div class="alert alert-info" role="alert">
    ...
    <p class="mb-0">You can download the Jupyter Notebook containing this Python analysis here: <a class="alert-link" href="https://github.com/christian-cleberg/data-science" rel="noreferrer,noopener">Lincoln_Business_Clusters.ipynb</a>.</p>
</div>
